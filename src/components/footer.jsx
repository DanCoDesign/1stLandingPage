...
export default function Footer() {
  ...
  return (
    <div className="relative bg-[#052825]">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 py-10 mx-auto lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-100">
              Sliht is HubSpot Theme Based On Engagement Design Framework, designed & developed by Nextemplate.
            </div>
            <div className="py-8 flex">
              <BookAMeeting title="Subscribe Now"
              />
            </div>
          </div>
          ...
          <div className="text-gray-300">
            ...
            <div className="flex mt-5 space-x-5 text-gray-300">
              ...
              <Link
                href="https://facebook.com/nextemplate"
                target="_blank"
                rel="noopener">
              ...
              <Link
                href="https://instagram.com/nextemplate"
                target="_blank"
                rel="noopener">
      ...
      {/* Do not remove this */}
      <Backlink />
      <hr className="h-[2px] border-0 bg-gray-700"></hr>
      <div className="flex justify-between p-8 container mx-auto">
        ...
        <p className="text-sm text-gray-100">
          Copyright © {new Date().getFullYear()}. Nextemplate. All right reserved.
        </p>
      </div>
    </div>
